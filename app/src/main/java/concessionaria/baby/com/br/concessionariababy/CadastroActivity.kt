package concessionaria.baby.com.br.concessionariababy
...
import concessionaria.baby.com.br.concessionariababy.api.UsuarioAPI
...
class CadastroActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCadastro.setOnClickListener() {
            val api = RetrofitClient.getInstance("http://concessionariapimarli.herokuapp.com").create(UsuarioAPI::class.java)
